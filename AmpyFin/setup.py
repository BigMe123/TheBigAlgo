from AmpyFin.config import API_KEY, API_SECRET, POLYGON_API_KEY, MONGO_DB_USER, MONGO_DB_PASS, mongo_url
...
def insert_rank_to_coefficient(i):
    try:
        ...
        # Clear existing entries, then insert new ones from 1 to i
