...
try:
    ...
    class AdvancedFeatureEngineering:
        """Dummy class when module is not available."""
...
class EnhancedTradingSystem:
    ...
    def _fetch_from_polygon(self, tickers, period, interval):
        ...
        try:
            # Check if polygon is installed before trying to import
            import importlib
            if importlib.util.find_spec("polygon") is None:
            ...
            logger.error(f"Error using Polygon API: {str(e)}")
            return []
